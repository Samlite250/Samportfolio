...
const Footer = () => {
  return (
    <footer className="bg-white dark:bg-dark-900 border-t border-gray-100 dark:border-dark-800 py-6 relative overflow-hidden">
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
          
          {/* Logo & Copyright (Matched) */}
          <div className="flex flex-col items-center md:items-start">
            <a href="#home" className="text-lg font-black text-gray-900 dark:text-white leading-none mb-1">
              Sam<span className="text-primary">.dev</span>
            </a>
            <p className="text-gray-900 dark:text-white text-[9px] font-bold uppercase tracking-[0.15em] leading-none">
          ...
          <div className="flex flex-col items-center md:items-end">
             <span className="text-gray-500 dark:text-gray-400 text-[9px] font-bold uppercase tracking-tight mb-1">Kigali, Rwanda</span>
             <button 
