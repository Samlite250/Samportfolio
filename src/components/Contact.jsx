            ...
            <form onSubmit={handleSubmit} className="text-left space-y-6">
              ...
              <div className="pt-2 space-y-4">
                ...
                <a 
                  ...
                  target="_blank" 
                  rel="noreferrer"
                  className="w-full h-14 px-6 flex items-center justify-center gap-3 bg-white border-2 border-primary text-primary font-bold rounded-xl hover:bg-primary hover:text-white transition-all shadow-sm hover:shadow-lg active:scale-95 group overflow-hidden"
                >
