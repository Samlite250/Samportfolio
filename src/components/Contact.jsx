          ...
          <form onSubmit={handleSubmit} className="text-left max-w-xl mx-auto space-y-6">
            ...
            <div className="pt-4 flex justify-center">
               <a 
                  ...
                  target="_blank" 
                  rel="noreferrer"
                  className="inline-flex items-center gap-2 px-8 py-3 bg-primary/10 text-primary border-2 border-primary font-bold rounded-lg hover:bg-primary hover:text-white transition-all shadow-sm hover:shadow-lg hover:-translate-y-0.5"
                >
