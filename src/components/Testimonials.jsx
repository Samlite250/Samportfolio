...
const Testimonials = () => {
  ...
  return (
    <section id="testimonials" aria-label="Client Testimonials" className="py-24 relative overflow-hidden bg-gray-50/50 dark:bg-dark-900/50 transition-colors duration-300">
