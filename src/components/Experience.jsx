        ...
        <div className="space-y-12 pl-4 md:pl-0">
          {experiences.map((exp, idx) => (
            ...
            >
              ...
              <div className="md:hidden absolute left-1.5 top-5 bottom-[-3rem] w-px bg-gray-700 group-last:bg-transparent"></div>
              ...
              <div className="hidden md:flex flex-col items-center relative">
                ...
                <div className="absolute top-4 bottom-[-3rem] w-px bg-gray-700 group-last:bg-transparent left-1.5"></div>
              </div>

              {/* Content */}
              <div className="md:w-3/4 glass-card p-8 rounded-2xl">
                <h3 className="text-xl font-bold text-white flex flex-col sm:flex-row sm:items-center sm:gap-2">
                  {exp.role} 
                ...
                <ul className="mt-6 space-y-3">
                  {exp.description.map((desc, dIdx) => (
                    <li key={dIdx} className="text-gray-400 flex items-start text-sm sm:text-base">
